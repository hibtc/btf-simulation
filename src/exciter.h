...
void Exciter_track_local_particle(ExciterData el, LocalParticle* part0){
    ...
    //start_per_particle_block (part0->part)
        ...
        // s is the reference accumulated path length in range (0; circumference)
        // it equals the s-coordinate of this element since the particle is here right now
        //double const s_element = LocalParticle_get_s(part);
